...
<html>
	...
	<h1>WELCOME TO MY GAMEWORLD</h1>
		<div class="container">
			<div class="row">
			<div class="col-12 mb-3 text-right">
				<a href="<?=base_url('Mathi/create')?> "class="btn btn-primary">Create New Game</a>
			</div>
				<div class="col-12">
					<div class="card">
							...
							<tbody>
								...
								if(count($products)>0){
									...
									<tr>
										...
										<td><a href="<?=base_url('Mathi/Edit/'.$product->id)?>">Edit</a></td>
										<td><a onclick="confirm('Are you sure want to delete?')" href="<?=base_url('Mathi/delete/'.$product->id)?>">Delete</a></td>
									</tr>
									<?php 
									}
								}
